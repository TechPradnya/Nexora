...
export type ImpureCircuits<PS> = {
  ...
  updateReputation(context: __compactRuntime.CircuitContext<PS>,
                   ...
                   success_0: boolean): Promise<__compactRuntime.CircuitResults<PS, []>>;
  createPolicy(context: __compactRuntime.CircuitContext<PS>,
               ...
               approvalRequired_0: boolean): Promise<__compactRuntime.CircuitResults<PS, []>>;
  ...
  releaseEscrow(context: __compactRuntime.CircuitContext<PS>,
                escrowId_0: Uint8Array,
                contractorAddress_0: { bytes: Uint8Array }): Promise<__compactRuntime.CircuitResults<PS, []>>;
  cancelEscrow(context: __compactRuntime.CircuitContext<PS>,
               escrowId_0: Uint8Array): Promise<__compactRuntime.CircuitResults<PS, []>>;
  getAgent(context: __compactRuntime.CircuitContext<PS>, agentId_0: Uint8Array): Promise<__compactRuntime.CircuitResults<PS, Agent>>;
  ...
  getEscrow(context: __compactRuntime.CircuitContext<PS>, escrowId_0: Uint8Array): Promise<__compactRuntime.CircuitResults<PS, Escrow>>;
}
