...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    this.circuits = {
      registerAgent: async (...args_1) => {
        ...
        const result_0 = await this._registerAgent_0(context,
                                                     partialProofData,
                                                     agentId_0,
                                                     nameCommitment_0,
                                                     role_0);
      ...
      fundEscrow: async (...args_1) => {
        ...
        const result_0 = await this._fundEscrow_0(context,
                                                  partialProofData,
                                                  escrowId_0,
                                                  amount_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      submitDeliverable: async (...args_1) => {
        if (args_1.length !== 3) {
        ...
        const result_0 = await this._submitDeliverable_0(context,
                                                         partialProofData,
                                                         escrowId_0,
                                                         commitment_0);
        partialProofData.output = { value: [], alignment: [] };
      ...
      approveDeliverable: async (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = await this._approveDeliverable_0(context,
                                                          partialProofData,
                                                          escrowId_0);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
      ...
      rejectDeliverable: async (...args_1) => {
        if (args_1.length !== 2) {
        ...
        const result_0 = await this._rejectDeliverable_0(context,
                                                         partialProofData,
                                                         escrowId_0);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
      ...
      cancelEscrow: async (...args_1) => {
        ...
        const result_0 = await this._cancelEscrow_0(context,
                                                    partialProofData,
                                                    escrowId_0);
        partialProofData.output = { value: [], alignment: [] };
        __compactRuntime.finalizeCallProofData(context, partialProofData);
      ...
      getAgent: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getAgent',
                                     'argument 1 (as invoked from Typescript)',
                                     'nexora.compact line 196 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(agentId_0.buffer instanceof ArrayBuffer && agentId_0.BYTES_PER_ELEMENT === 1 && agentId_0.length === 32)) {
        ...
        const result_0 = await this._getAgent_0(context,
                                                partialProofData,
                                                agentId_0);
      ...
      getPolicy: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getPolicy',
                                     'argument 1 (as invoked from Typescript)',
                                     'nexora.compact line 201 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(policyId_0.buffer instanceof ArrayBuffer && policyId_0.BYTES_PER_ELEMENT === 1 && policyId_0.length === 32)) {
      ...
      getEscrow: async (...args_1) => {
        ...
        if (!(typeof(contextOrig_0) === 'object' && contextOrig_0.callContext.currentQueryContext != undefined)) {
          __compactRuntime.typeError('getEscrow',
                                     'argument 1 (as invoked from Typescript)',
                                     'nexora.compact line 206 char 1',
                                     'CircuitContext',
                                     contextOrig_0)
        }
        if (!(escrowId_0.buffer instanceof ArrayBuffer && escrowId_0.BYTES_PER_ELEMENT === 1 && escrowId_0.length === 32)) {
        ...
        const result_0 = await this._getEscrow_0(context,
                                                 partialProofData,
                                                 escrowId_0);
  ...
  async _authCommitment_0(context, partialProofData, agentId_0) {
  ...
  async _requireAgent_0(context, partialProofData, agentId_0) {
    ...
    __compactRuntime.assert(this._equal_1(_descriptor_0.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                                    ...
                                                                                                    [
                                                                                                     ...
                                                                                                     { popeq: { cached: false,
                                                                                                                result: undefined } }]).value),
                                          await this._authCommitment_0(context,
                                                                       partialProofData,
                                                                       agentId_0)),
                            'Agent authorization failed');
    return [];
  }
  async _registerAgent_0(context,
                         partialProofData,
                         agentId_0,
                         nameCommitment_0,
                         role_0)
  {
    ...
    __compactRuntime.queryLedgerState(context,
                                      ...
                                      [
                                       ...
                                       { ins: { cached: false, n: 1 } },
                                       { ins: { cached: true, n: 1 } }]);
    const tmp_1 = await this._authCommitment_0(context,
                                               partialProofData,
                                               agentId_0);
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
  ...
  async _updateReputation_0(context, partialProofData, escrowId_0, success_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const escrow_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                               ...
                                                                               [
                                                                                ...
                                                                                { popeq: { cached: false,
                                                                                           result: undefined } }]).value);
    __compactRuntime.assert(escrow_0.status === 7n || escrow_0.status === 6n,
                            'Settlement outcome is not final');
    await this._requireAgent_0(context, partialProofData, escrow_0.verifier);
                        ...
                        amount_0)
  {
    ...
    await this._requireAgent_0(context, partialProofData, clientId_0);
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    __compactRuntime.assert(contractorAgent_0.role === policy_0.requiredRole,
                            'Contractor role violates policy');
    if (policy_0.verifierRequired) {
      __compactRuntime.assert(!this._equal_2(verifier_0, contractor_0),
  ...
  async _fundEscrow_0(context, partialProofData, escrowId_0, amount_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const e_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          [
                                                                           ...
                                                                           { popeq: { cached: false,
                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(e_0.status === 1n, 'Escrow is not awaiting funding');
    await this._requireAgent_0(context, partialProofData, e_0.client);
    __compactRuntime.assert(amount_0 === e_0.amount,
  ...
  async _submitDeliverable_0(context, partialProofData, escrowId_0, commitment_0)
  {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
    ...
    const e_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          [
                                                                           ...
                                                                           { popeq: { cached: false,
                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(e_0.status === 2n, 'Escrow is not funded');
    await this._requireAgent_0(context, partialProofData, e_0.contractor);
    const tmp_0 = { client: e_0.client,
                    contractor: e_0.contractor,
                    verifier: e_0.verifier,
                    policyId: e_0.policyId,
  ...
  async _approveDeliverable_0(context, partialProofData, escrowId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const e_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          [
                                                                           ...
                                                                           { popeq: { cached: false,
                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(e_0.status === 3n,
                            'Escrow is not ready for verification');
    await this._requireAgent_0(context, partialProofData, e_0.verifier);
    const tmp_0 = { client: e_0.client,
                    contractor: e_0.contractor,
                    verifier: e_0.verifier,
                    policyId: e_0.policyId,
  ...
  async _rejectDeliverable_0(context, partialProofData, escrowId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  async _releaseEscrow_0(context,
                         partialProofData,
                         escrowId_0,
                         contractorAddress_0)
  {
    ...
    const e_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          [
                                                                           ...
                                                                           { popeq: { cached: false,
                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(e_0.status === 5n && e_0.approved,
  ...
  async _cancelEscrow_0(context, partialProofData, escrowId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
    ...
    const e_0 = _descriptor_4.fromValue(__compactRuntime.queryLedgerState(context,
                                                                          ...
                                                                          [
                                                                           ...
                                                                           { popeq: { cached: false,
                                                                                      result: undefined } }]).value);
    __compactRuntime.assert(e_0.status === 1n || e_0.status === 6n,
  ...
  async _getAgent_0(context, partialProofData, agentId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
  ...
  async _getEscrow_0(context, partialProofData, escrowId_0) {
    __compactRuntime.assert(_descriptor_3.fromValue(__compactRuntime.queryLedgerState(context,
                                                                                      partialProofData,
                                                                                      [
                                                                                       { dup: { n: 0 } },
...
export const expectedVk = {
  'approveDeliverable': '862f9daf13467d71ae112e06072ddadaef0b7f25ede6a76cb2c97f5b28c53cfa',
  'cancelEscrow': '4033f8bad11226f6ae88cdf4abc150e9c9067a158dbaba6e52f0b25170b65095',
  'createEscrow': '51772912c446f2edb9de3f4312ebb65429f352ae51dc38e211f4cfbf6e75b58f',
  'createPolicy': '191da26290454f7abe4553ac67ce428a6728d97fe9aa1cfce9b5e7712e202a37',
  'fundEscrow': 'f12c1602f436ad5aef56555f10b1e42319bc197e685148bcbf435cc851d903a0',
  'getAgent': '7e1a708f6761b00a8b9b1fa5d73b1b9104f30503bcd1c4f53a5f5a5a9d6eba93',
  'getEscrow': '9be925ed448f0051ef3a6db23b786cae6694e39ae543ebbc54bcc7806693d59c',
  'getPolicy': '96d0dfb4a72f413d646e1a9d8ff85be175b7f001fdbc063007b87cd3d063df47',
  'registerAgent': 'ae9949e21d8200145ddaf323b501533f67189d541d4b0bfd2f351d2ebaf8a51f',
  'rejectDeliverable': 'ece38a2abe8339634607076381c683d2100eb109f6df91f696f140cc77dc6a01',
  'releaseEscrow': '0d3a6be2e3b51ba1aa6a60a3af4b21dd8d50fbba90642fff14d438e341d0d9ca',
  'submitDeliverable': '2dc0645d978dd576e654d204608c89bebae1e95382e33d961f8e49f710824e19',
  'updateReputation': '3e105d515ea7291e3be2fad23a5e35d978a2b9c223660a1b01b67b71749c88ff',
};
